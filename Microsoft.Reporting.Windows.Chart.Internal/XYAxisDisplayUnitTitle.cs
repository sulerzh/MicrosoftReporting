...
namespace Microsoft.Reporting.Windows.Chart.Internal
{
    internal class XYAxisDisplayUnitTitle : Title
    {
        ...
        internal XYAxisDisplayUnitTitle(XYAxisPresenter presenter)
        {
            ...
            this.SetBinding(ContentControl.ContentProperty, new Binding("ActualDisplayUnitTitle")
            {
                Source = (object)this.Axis
            });
            this.SetBinding(FrameworkElement.StyleProperty, new Binding("DisplayUnitTitleStyle")
            {
                Source = (object)this.Axis
            });
